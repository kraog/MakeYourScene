...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        // Creating Text View object from header.xml for name
                ...
                profile = (ImageView) itemView.findViewById(R.id.avatar);// Creating Image view object from header.xml for profile pic
    ...
    public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_menu,parent,false); //Inflating the layout
